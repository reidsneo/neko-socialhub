...
namespace Neko\Socialhub\Providers;



use Neko\Socialhub\Contracts;
use Neko\Socialhub\Exceptions;
use Neko\Socialhub\Exceptions\InvalidArgumentException;
use Neko\Socialhub\User;
...
class Coding extends Base
{
     ...
     * @throws \Neko\Socialhub\Exceptions\BadRequestException
     */
